...
func init() {
	...
	scanGitlabCmd.Flags().Bool("enterprise-scan", false, "Override github.com with a url specified via the --enterprise-url parameter")
	scanGitlabCmd.Flags().String("enterprise-url", "", "Enterprise base url, must include protocol. IE https://github.org.com")
	...
	err = viperScanGitlab.BindPFlag("enterprise-scan", scanGitlabCmd.Flags().Lookup("enterprise-scan"))
	err = viperScanGitlab.BindPFlag("enterprise-url", scanGitlabCmd.Flags().Lookup("enterprise-url"))
